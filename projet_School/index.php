...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row my-5">
                ...
                <div class="col-5 d-flex justify-content-center">
                    <input type="search" id="site-search" name="q" onkeyup="search_site()" placeholder="Tape un prenom">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            ?>
                                            ">
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control" id="inputGroupFile02" name="uploadfile2"
                                        value="">
                                </div>
                                <div class="row mb-3">
                                    <label for="Nom" class="col-sm-2 col-form-label">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Nom" name='Nom2' required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="Prénom" class="col-sm-2 col-form-label">Prénom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Prenom" name='Prenom2' required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="Téléphone" class="col-sm-2 col-form-label">Téléphone</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Tel" name='Tel2' required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="Adresse" class="col-sm-2 col-form-label">Adresse</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Adresse" name='Adresse2' required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="Email" class="col-sm-2 col-form-label">Email</label>
                                ...
                                <div>
                                    <label for="" class="col-sm-2 col-form-label">Classe</label>
                                    <select class="form-select my-2" aria-label="Default select example" name='classe2'
                                        required>
                                        <option selected disabled>Choisir la classe</option>
                                        <option name='CM1' value="CM1">CM1</option>
                                        <option name='CM2' value="CM2">CM2</option>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($verif->fetchColumn() == 0) {
                if ($classe != 'Choisir la classe') {
                    $sql = " INSERT INTO personne (Nom, Prenom, Tel, Adresse, Email, classe) VALUES ('$Nom', '$Prenom','$Tel', '$Adresse', '$Email', '$classe')";
                    $pdo->exec($sql);

                    // Ajout de ligne dans la table eleves
                    $personne_id = $pdo->lastInsertId();
                    $sql_prof = "INSERT INTO professeurq (personne_ID) VALUES ('$personne_id')";
                    $sql2 = $pdo->prepare($sql_prof);
                    $sql2->execute();
                    ...
                    $sqlupload = "UPDATE image_upload SET filename=('$filename') WHERE personne_ID = '$personne_id' ";
        ...
        JOIN professeurq ON personne.ID = professeurq.personne_ID 
                    ...
                    <table>
                        ...
                        while ($rows = $query->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr class="search_prenom">
                                ...
                                ROW OF EVERY COLUMN -->
                                <td>
                                    <img src="<?php echo './image/' . $rows['filename']; ?>" alt="Image" class="img_list">
                                </td>
                                <td>
                                    <?php echo $rows['Nom']; ?>
                                </td>
                                ...
                                <td>
                                    <?php echo $rows['classe']; ?>
                                </td>
                                <td><button type="button" data-bs-toggle="modal" data-bs-target="#ModalUpdate">edit</button>
                                </td>
                            </tr>
